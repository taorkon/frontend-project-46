...
[![hexlet-check](https://github.com/taorkon/frontend-project-46/actions/workflows/hexlet-check.yml/badge.svg)](https://github.com/taorkon/frontend-project-46/actions)
...
```bash
git clone https://github.com/taorkon/frontend-project-46.git
